...
from demo.console_utils import get_yes_no_input, get_string_input, get_int_input, get_multiple_choice
...
class TestGetMultipleChoice(unittest.TestCase):
    ...
    def test_valid_input(self, mock_get_int_input):
        ...
        mock_get_int_input.assert_called_with("Select an option: " + choice_string, range(len(choices) + 1))
